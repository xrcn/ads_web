...
const loadTemplateSubTab=()=>{if(templateSubTab.value==='commands')loadTemplateCommands();if(templateSubTab.value==='admins'){loadSpecialTop();loadPermissionAdmins();}if(templateSubTab.value==='reminders')loadReminderConfig();};
watch(templateSubTab,loadTemplateSubTab);watch(activeTab,(value)=>{if(value==='queue')loadQueueTab();if(value==='timing')loadTiming();if(value==='schedule')loadSchedulePlan();if(value==='report')loadReport();if(value==='checkin')loadStatistics();if(value==='template')loadTemplateSubTab();});watch(selectedGroupId,()=>{if(activeTab.value==='queue')loadQueueTab();if(activeTab.value==='timing')loadTiming();if(activeTab.value==='schedule')loadSchedulePlan();if(activeTab.value==='report')loadReport();if(activeTab.value==='checkin')loadStatistics();if(activeTab.value==='template')loadTemplateSubTab();});
