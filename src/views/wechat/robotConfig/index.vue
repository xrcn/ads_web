...
import { batchClearWechatRobotGroupSchedulePlan, batchSaveWechatRobotGroupSchedulePlan, cancelWechatRobotGroupSpecialTop, getWechatRobotGroupConfigOverview, getWechatRobotGroupList, getWechatRobotGroupQueueRules, getWechatRobotGroupScheduleExceptions, getWechatRobotGroupSchedulePlan, getWechatRobotGroupSchedulePlanAudit, getWechatRobotGroupScheduleTiming, getWechatRobotGroupSpecialTopList, grantWechatRobotGroupSpecialTop, restoreWechatRobotGroupFixedException, restoreWechatRobotGroupHostException, saveWechatRobotGroupFixedException, saveWechatRobotGroupHostException, saveWechatRobotGroupQueueRules, saveWechatRobotGroupSchedulePlan, saveWechatRobotGroupScheduleTiming } from '/@/api/wechatRobotGroup';
...
watch(activeTab,(value)=>{if(value==='queue')loadQueueTab();if(value==='timing')loadTiming();if(value==='schedule')loadSchedulePlan();});watch(selectedGroupId,()=>{if(activeTab.value==='queue')loadQueueTab();if(activeTab.value==='timing')loadTiming();if(activeTab.value==='schedule')loadSchedulePlan();});
